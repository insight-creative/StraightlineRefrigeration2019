			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				<header class="entry-header">
					...
					if ( 'post' === get_post_type() ) :
						...
						<div class="entry-meta">
							<?php
							straightlineRefrigerationResponsive_posted_on();
							straightlineRefrigerationResponsive_posted_by();
							?>
						</div><!-- .entry-meta -->
					<?php endif; ?>
				</header><!-- .entry-header -->

				<?php straightlineRefrigerationResponsive_post_thumbnail(); ?>
				...
				<div class="continue-reading">
					...
					$read_more_link = sprintf(
						...
						wp_kses( __( 'Continue Reading %s', 'straightlineRefrigerationResponsive' ), array( 'span' => array( 'class' => array() ) ) ),
